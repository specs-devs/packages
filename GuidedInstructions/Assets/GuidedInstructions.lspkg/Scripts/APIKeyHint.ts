...
export class APIKeyHint extends BaseScriptComponent {
  @ui.label('<span style="color: #60A5FA;">APIKeyHint – API key validation hint</span><br/><span style="color: #94A3B8; font-size: 11px;">Displays a hint when the Remote Service Gateway API key has not been set.</span>')
  @ui.separator
