...
export class HandAttacher extends BaseScriptComponent {
    ...
    @input
    @label("Hand")
    @hint("Which hand to attach to.")
    @widget(
        new ComboBoxWidget([
            new ComboBoxItem("Left", "left"),
            new ComboBoxItem("Right", "right"),
            new ComboBoxItem("Dominant", "dominant"),
            new ComboBoxItem("Non-dominant", "nondominant"),
        ])
    )
    ...
    @input
    @label("Joint")
    @hint("Hand joint to follow (SIK TrackedHand property name).")
    @widget(
        new ComboBoxWidget([
            new ComboBoxItem("Wrist", "wrist"),
            new ComboBoxItem("Thumb base", "thumbToWrist"),
            new ComboBoxItem("Thumb knuckle", "thumbKnuckle"),
            new ComboBoxItem("Thumb mid", "thumbMidJoint"),
            new ComboBoxItem("Thumb tip", "thumbTip"),
            new ComboBoxItem("Index base", "indexToWrist"),
            new ComboBoxItem("Index knuckle", "indexKnuckle"),
            new ComboBoxItem("Index mid", "indexMidJoint"),
            new ComboBoxItem("Index upper", "indexUpperJoint"),
            new ComboBoxItem("Index tip", "indexTip"),
            new ComboBoxItem("Middle base", "middleToWrist"),
            new ComboBoxItem("Middle knuckle", "middleKnuckle"),
            new ComboBoxItem("Middle mid", "middleMidJoint"),
            new ComboBoxItem("Middle upper", "middleUpperJoint"),
            new ComboBoxItem("Middle tip", "middleTip"),
            new ComboBoxItem("Ring base", "ringToWrist"),
            new ComboBoxItem("Ring knuckle", "ringKnuckle"),
            new ComboBoxItem("Ring mid", "ringMidJoint"),
            new ComboBoxItem("Ring upper", "ringUpperJoint"),
            new ComboBoxItem("Ring tip", "ringTip"),
            new ComboBoxItem("Pinky base", "pinkyToWrist"),
            new ComboBoxItem("Pinky knuckle", "pinkyKnuckle"),
            new ComboBoxItem("Pinky mid", "pinkyMidJoint"),
            new ComboBoxItem("Pinky upper", "pinkyUpperJoint"),
            new ComboBoxItem("Pinky tip", "pinkyTip"),
        ])
    )
    ...
    @input
    @hint("Follow the hand joint's position")
    enablePosition: boolean = true;

    @input
    @hint("Follow the hand joint's rotation")
