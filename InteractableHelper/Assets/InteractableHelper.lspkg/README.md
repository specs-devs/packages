...
A powerful event-driven animation system that connects Specs Interaction Kit (SIK) events to visual and audio responses. This package provides a no-code interface for creating interactive experiences with transform animations, material property changes, blendshape morphing, audio playback, and video control.
