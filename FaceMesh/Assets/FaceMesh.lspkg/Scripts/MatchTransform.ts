/**
 * Specs Inc. 2026
 * Transform matching utility that synchronizes position, rotation, and scale with a target object.
 * Supports smooth lerping, axis constraints, and offset positioning for flexible object following.
 */
@component
export class MatchTransformTS extends BaseScriptComponent {
    @ui.separator
    @ui.label('<span style="color: #60A5FA;">Target Configuration</span>')
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Specify the target object whose transform should be matched</span>')
    ...
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Configure position matching with offset and lerp smoothing</span>')
    ...
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Configure smooth rotation matching speed</span>')
    ...
    @ui.separator
    @ui.label('<span style="color: #60A5FA;">Scale Settings</span>')
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Configure smooth scale matching speed</span>')
    ...
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Lock specific position axes to prevent movement on those axes</span>')
    ...
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Lock specific rotation axes to prevent rotation on those axes</span>')
    ...
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Lock specific scale axes to prevent scaling on those axes</span>')
