...
export class Line extends BaseScriptComponent {
  ...
  @ui.separator
  @ui.label('<span style="color: #60A5FA;">Line Endpoints</span>')
  @ui.label('<span style="color: #94A3B8; font-size: 11px;">Define the start and end points for the line visualization</span>')
  ...
  @ui.separator
  @ui.label('<span style="color: #60A5FA;">Line Material</span>')

  @input
  private lineMaterial!: Material

  @ui.separator
  @ui.label('<span style="color: #60A5FA;">Line Colors</span>')
  @ui.label('<span style="color: #94A3B8; font-size: 11px;">Set gradient colors from start to end point</span>')
  ...
  @ui.separator
  @ui.label('<span style="color: #60A5FA;">Line Appearance</span>')
  @ui.label('<span style="color: #94A3B8; font-size: 11px;">Configure line width, length, and visual style</span>')
