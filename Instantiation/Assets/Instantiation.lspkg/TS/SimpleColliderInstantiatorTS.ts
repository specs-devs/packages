...
export class SimpleColliderInstantiatorTS extends BaseScriptComponent {
    @ui.separator
    @ui.label('<span style="color: #60A5FA;">Collider Configuration</span>')
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Define the prefab and target object with collider shape</span>')
    ...
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Configure number of instances and placement mode (inside or surface)</span>')
    ...
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Control prefab scaling with optional random variation</span>')
