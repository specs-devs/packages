...
A comprehensive collection of asset packages and utilities for building Lens experiences on Spectacles.

## What you'll find here

This repository contains multiple asset packages showcasing different features and capabilities available when building for Spectacles. Each package is a complete, working example that you can use as a starting point for your own projects.

## Package index

Every package folder in this repository (open in Lens Studio or browse on GitHub):

| | | |
|:--|:--|:--|
| [AccessComponents](./AccessComponents/) | [CompositeCameraTexture](./CompositeCameraTexture/) | [CropCameraTexture](./CropCameraTexture/) |
| [FaceMesh](./FaceMesh/) | [FastUI](./FastUI/) | [FunctionCallHelper](./FunctionCallHelper/) |
| [GuidedInstructions](./GuidedInstructions/) | [HandAttacher](./HandAttacher/) | [Instantiation](./Instantiation/) |
| [InteractableHelper](./InteractableHelper/) | [Leaderboard](./Leaderboard/) | [LSTween](./LSTween/) |
...
| [SnapDecorators](./SnapDecorators/) | [Solvers](./Solvers/) | [Spectacles3DHandHints](./Spectacles3DHandHints/) |
| [SpectaclesInteractionKitExamples](./SpectaclesInteractionKitExamples/) | [SpectaclesNavigationKit](./SpectaclesNavigationKit/) | [SpectaclesShaderLibrary](./SpectaclesShaderLibrary/) |
| [SupabaseClient](./SupabaseClient/) | [SurfacePlacement](./SurfacePlacement/) | [VolumetricLine](./VolumetricLine/) |
| [WorldQueryHit](./WorldQueryHit/) | | |
...
<a href="https://developers.snap.com/spectacles/about-spectacles-features/compatibility-list">
  <img src="https://img.shields.io/badge/LLM-Light%20Gray?color=D3D3D3" />
    ...
    <td align="center" valign="top" width="33%">
      <a href="./SpectaclesNavigationKit/">
        <img src="./SpectaclesNavigationKit/Assets/AssetImage/SpectaclesNavigationKit.png" alt="spectacles-navigation-kit" width="250px" />
      </a>
      <h3>Spectacles Navigation Kit</h3>
      <p>
<a href="https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-interaction-kit/features/overview?">
  <img src="https://img.shields.io/badge/SIK-Light%20Gray?color=D3D3D3" />
</a>
...
<a href="https://developers.snap.com/spectacles/about-spectacles-features/apis/location?">
  <img src="https://img.shields.io/badge/Location-Light%20Gray?color=D3D3D3" />
      ...
      <p>Set of components designed to simplify the development of navigation experiences for Spectacles.</p>
    </td>
    <td align="center" valign="top" width="33%">
      <a href="./SpectaclesInteractionKitExamples/">
        <img src="./SpectaclesInteractionKitExamples/Assets/AssetImage/SpectaclesInteractionKitExamples.svg.png" alt="spectacles-interaction-kit-examples" width="250px" />
      </a>
      <h3>Spectacles Interaction Kit Examples</h3>
      <p>
<a href="https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-interaction-kit/features/overview?">
  <img src="https://img.shields.io/badge/SIK-Light%20Gray?color=D3D3D3" />
</a>
...
<table>
  <tr>
    <td align="center" valign="top" width="33%">
      <a href="./Spectacles3DHandHints/">
        <img src="./Spectacles3DHandHints/Assets/AssetImage/Spectacles3DHandHints.png" alt="spectacles-3d-hand-hints" width="250px" />
      </a>
      <h3>Spectacles 3D Hand Hints</h3>
      <p>
<a href="https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-interaction-kit/features/overview?">
  <img src="https://img.shields.io/badge/SIK-Light%20Gray?color=D3D3D3" />
</a>
...
<a href="https://developers.snap.com/lens-studio/features/scripting/scripting-overview?">
  <img src="https://img.shields.io/badge/Scripting-Light%20Gray?color=D3D3D3" />
      ...
      <p>Low to medium fidelity prototyping tool for Spectacles Interaction Kit components without code.</p>
    </td>
    <td align="center" valign="top" width="33%">
...
<a href="https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-interaction-kit/features/overview?">
  <img src="https://img.shields.io/badge/AR%20Tracking-Light%20Gray?color=D3D3D3" />
    ...
    <td align="center" valign="top" width="33%">
      <a href="./LSTween/">
        <img src="./LSTween/Assets/AssetImage/LSTween.png" alt="ls-tween" width="250px" />
      </a>
      <h3>LSTween</h3>
      <p>
<a href="https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-interaction-kit/features/overview?">
...
<a href="https://developers.snap.com/lens-studio/features/scripting/scripting-overview?">
  <img src="https://img.shields.io/badge/Scripting-Light%20Gray?color=D3D3D3" />
      ...
      <p>Helps developers with animation handling in Lens Studio.</p>
    </td>
  </tr>
  <tr>
    <td align="center" valign="top" width="33%">
...
<table>
  <tr>
    <td align="center" valign="top" width="33%">
      <a href="./FastUI/">
        <img src="./FastUI/Assets/AssetImage/FastUI.png" alt="fast-ui" width="250px" />
      </a>
      <h3>FastUI</h3>
      <p>
<a href="https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-interaction-kit/features/overview?">
...
<a href="https://developers.snap.com/lens-studio/features/scripting/scripting-overview?">
  <img src="https://img.shields.io/badge/Scripting-Light%20Gray?color=D3D3D3" />
      ...
      <p>Runtime UI pattern generator that creates customizable grids and menus without prefabs.</p>
    </td>
    <td align="center" valign="top" width="33%">
      <a href="./Leaderboard/">
        <img src="./Leaderboard/Assets/AssetImage/Leaderboard.png" alt="leaderboard" width="250px" />
      </a>
      <h3>Leaderboard</h3>
      <p>
<a href="https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-interaction-kit/features/overview?">
...
<a href="https://developers.snap.com/lens-studio/features/lens-cloud/lens-cloud-overview?">
  <img src="https://img.shields.io/badge/Lens%20Cloud-Light%20Gray?color=D3D3D3" />
</a>
<a href="https://developers.snap.com/spectacles/about-spectacles-features/connected-lenses/overview?">
  <img src="https://img.shields.io/badge/Networking-Light%20Gray?color=D3D3D3" />
      ...
      <p>Simple set up to get started ranking players in your lens.</p>
    </td>
    <td align="center" valign="top" width="33%">
...
<a href="https://developers.snap.com/lens-studio/features/graphics/rendering-overview?">
  <img src="https://img.shields.io/badge/3D%20Rendering-Light%20Gray?color=D3D3D3" />
    ...
    <td align="center" valign="top" width="33%">
      <a href="./SpectaclesShaderLibrary/">
        <img src="./SpectaclesShaderLibrary/Assets/AssetImage/SpectaclesShaderLibrary.png" alt="spectacles-shader-library" width="250px" />
      </a>
      <h3>Spectacles Shader Library</h3>
      <p>
<a href="https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-interaction-kit/features/overview?">
  <img src="https://img.shields.io/badge/SIK-Light%20Gray?color=D3D3D3" />
</a>
...
2. Open any package folder in Lens Studio
3. Explore the asset packages and start building!
