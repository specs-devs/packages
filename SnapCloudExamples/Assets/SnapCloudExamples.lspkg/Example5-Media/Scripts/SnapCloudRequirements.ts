 ...
 * displays setup instructions for connected cloud experiences in Example5-Media context.
 */
@component
export class SnapCloudRequirements extends BaseScriptComponent {
  ...
  @ui.label('<span style="color: #94A3B8; font-size: 11px;">Centralized Supabase project settings for Example5-Media</span>')
  ...
  @ui.separator
  @ui.label('<span style="color: #60A5FA;">Warning Configuration</span>')
  @ui.label('<span style="color: #94A3B8; font-size: 11px;">Setup instructions and validation warnings</span>')
