...
```typescript
import { InteractionHintController, HandMode, HandAnimationsLibrary } from "./Specs3DHandHints.lspkg/Scripts/InteractionHintController";
