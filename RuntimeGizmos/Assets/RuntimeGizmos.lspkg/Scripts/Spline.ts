...
export class Spline extends BaseScriptComponent {
  @ui.separator
  @ui.label('<span style="color: #60A5FA;">Spline Configuration</span>')
  @ui.label('<span style="color: #94A3B8; font-size: 11px;">Configure spline control points, interpolation, and curve properties</span>')
