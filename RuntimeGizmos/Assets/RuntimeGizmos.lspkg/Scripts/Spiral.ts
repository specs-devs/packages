...
import {
  ...
  export class Spiral extends BaseScriptComponent {
    @ui.separator
    @ui.label('<span style="color: #60A5FA;">Spiral Configuration</span>')
    @ui.label('<span style="color: #94A3B8; font-size: 11px;">Configure spiral center, radius, loops, and growth pattern</span>')
