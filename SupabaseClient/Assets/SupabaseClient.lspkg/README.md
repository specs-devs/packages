...
export class SupabaseExample extends BaseScriptComponent {
    ...
    async insertData() {
        const { data, error } = await this.supabase
            .from('messages')
            .insert({ content: 'Hello from Specs!' });
