/**
 * Leaderboard item component for a leaderboard entry.
 * 
 * THIS COMPONENT IS REQUIRED FOR EACH LEADERBOARD ITEM PREFAB
 * 
 * The leaderboard item prefab MUST have this structure:
 * - LeaderboardItem (root object with ScreenTransform and this component)
 *   - Position/Placement/Rank (child with Text component) - Shows the rank number
 *   - Name (child with Text component) - Shows the player name
 *   - Score (child with Text component) - Shows the player score
 * 
 * All three text children are REQUIRED for the leaderboard to display properly.
 * This component must be attached to the root object of the prefab.
 */
@component
